...
//		page.putField(catalogue.getTitle(), tmp);
	...
	public void run() {
		Spider.create(new ContentWebMagic()).addPipeline(new JsonFilePipeline("/Users/wangda/Desktop/scrapy/CoilingDragon")).addUrl(catalogue.getOriginUrl()).thread(1).run();		
	}
